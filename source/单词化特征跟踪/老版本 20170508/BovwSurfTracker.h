...
//自编库
#include "TrainBoVWofSURF.h"			//视觉词库类
...
private:
	...
	//特征检测与匹配
	cv::SurfFeatureDetector surf_feature_detector_;				//surf特征检测器
	cv::SurfDescriptorExtractor surf_descriptor_extractor_;		//surf特征描述向量生成器
	...
	//图片中的SURF特征单词
	TrainBoVWofSURF bovw_surf_;						//视觉词典
